        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <AnimatedSection animationType="slide-in-left">
            ...
            <p className="text-lg text-white/90 mb-8">
              Built by U.S. and Korean aesthetic professionals, our team blends global beauty innovation with proven medspa operations.   We help you differentiate through superior product sourcing and client acquisition—so you can focus on delivering great outcomes.
            </p>
