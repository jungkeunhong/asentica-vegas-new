          ...
          <div className="text-white">
            <AnimatedSection>
              <h1 id="hero-heading" className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                ...
                <span className="relative flex w-full justify-center overflow-hidden text-center align-left md:pb-4 md:pt-1">
                  &nbsp;
                  {titles.map((title, index) => (
                    <motion.span
                      key={index}
                      className="absolute text-asentica-gold font-semibold"
