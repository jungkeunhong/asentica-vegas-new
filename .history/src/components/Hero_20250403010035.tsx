                  ...
                  <div className="flex flex-col items-start">
                    <div className="flex items-start gap-4">
                      <svg width="80" height="80" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="50" cy="50" r="35" stroke="#2B1608/10" strokeWidth="2"/>
                        <path d="M50 30 L50 70" stroke="#2B1608/10" strokeWidth="2"/>
                        <path d="M30 50 L70 50" stroke="#2B1608/10" strokeWidth="2"/>
                        <circle cx="50" cy="50" r="10" stroke="#2B1608/10" strokeWidth="2"/>
                        <circle cx="35" cy="35" r="2" fill="#2B1608/10"/>
                        <circle cx="65" cy="65" r="2" fill="#2B1608/10"/>
                      </svg>
                    </div>
