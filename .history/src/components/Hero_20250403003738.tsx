                  ...
                  <div className="flex flex-col items-start">
                    <div className="flex items-start gap-4">
                      <svg width="60" height="60" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="50" cy="50" r="35" stroke="asentica-brown" strokeWidth="2"/>
                        <path d="M50 30 L50 70" stroke="asentica-brown" strokeWidth="2"/>
                        <path d="M30 50 L70 50" stroke="asentica-brown" strokeWidth="2"/>
                        <circle cx="50" cy="50" r="10" stroke="asentica-brown" strokeWidth="2"/>
                        <circle cx="35" cy="35" r="2" fill="asentica-brown"/>
                        <circle cx="65" cy="65" r="2" fill="asentica-brown"/>
                      </svg>
                      <h2 className="text-asentica-gold/90 text-5xl font-bold">500<span className="text-3xl">+</span></h2>
                    </div>
                    <p className="text-asentica-gold/90 text-xl font-medium mt-2">Medspas Helped<br />and Coached</p>
                  </div>
                </div>
              </div>
            </div>
