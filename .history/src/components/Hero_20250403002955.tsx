        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <AnimatedSection delay={0.3} className="relative">
            <div className="relative rounded-xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 w-[400px] ml-6 bg-gradient-to-t from-asentica-brown to-transparent">
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg flex items-center">
                  <div className="mr-4">
                    <svg width="60" height="60" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="50" cy="50" r="45" stroke="#2B1608" strokeWidth="2"/>
                      <path d="M50 30 L50 70" stroke="#2B1608" strokeWidth="2"/>
                      <path d="M30 50 L70 50" stroke="#2B1608" strokeWidth="2"/>
                      <circle cx="50" cy="50" r="15" stroke="#2B1608" strokeWidth="2"/>
                      <circle cx="35" cy="35" r="3" fill="#2B1608"/>
                      <circle cx="65" cy="65" r="3" fill="#2B1608"/>
                    </svg>
                  </div>
                  <div>
