                ...
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg flex items-center">
                  <div className="mr-4">
                    <svg width="60" height="60" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="50" cy="50" r="45" stroke="#A3C5BD" strokeWidth="2"/>
                      <path d="M50 30 L50 70" stroke="#A3C5BD" strokeWidth="2"/>
                      <path d="M30 50 L70 50" stroke="#A3C5BD" strokeWidth="2"/>
                      <circle cx="50" cy="50" r="15" stroke="#A3C5BD" strokeWidth="2"/>
                      <circle cx="35" cy="35" r="3" fill="#A3C5BD"/>
                      <circle cx="65" cy="65" r="3" fill="#A3C5BD"/>
                    </svg>
                  </div>
                  <div>
                    <h2 className="text-[#1D4D4F] text-5xl font-bold">500<span className="text-3xl">+</span></h2>
                    <p className="text-asentica-brown/70 text-xl font-medium">Medspas Helped<br />and Coached</p>
                  </div>
                </div>
              </div>
            </div>
