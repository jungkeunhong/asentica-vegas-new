          ...
          <AnimatedSection delay={0.3} className="relative">
            <div className="relative rounded-xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-asentica-brown to-transparent">
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg flex items-center gap-8 w-[280px]">
                  <div className="flex justify-center items-center w-1/2">
                    <svg width="80" height="80" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="50" cy="50" r="35" stroke="#d69b78" strokeWidth="2"/>
                      <path d="M50 30 L50 70" stroke="#d69b78" strokeWidth="2"/>
                      <path d="M30 50 L70 50" stroke="#d69b78" strokeWidth="2"/>
                      <circle cx="50" cy="50" r="10" stroke="#d69b78" strokeWidth="2"/>
                      <circle cx="35" cy="35" r="2" fill="#d69b78"/>
                      <circle cx="65" cy="65" r="2" fill="#d69b78"/>
                    </svg>
                  </div>
                  <div className="flex flex-col items-start w-3/2">
                    <h2 className="text-[#d69b78] text-5xl font-bold">500<span className="text-3xl">+</span></h2>
                    <p className="text-[#d69b78] text-xl font-medium mt-2">Medspas Helped<br />and Coached</p>
                  </div>
                </div>
              </div>
            </div>
